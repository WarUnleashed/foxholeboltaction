...
<gameSystem xmlns="http://www.battlescribe.net/schema/gameSystemSchema" id="4c6f1c8a-9f4d-4e4d-b2f7-2d71860d3f21" name="Bolt Action: Foxhole (Unofficial)" revision="16" battleScribeVersion="2.03" authorName="Foxhole Bolt Action data" type="gameSystem">
  <costTypes>
